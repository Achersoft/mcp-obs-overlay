            ...
            return (
                <div style={{background: `${backgroundState}`, width: `${gameState.characterWidth}px`, paddingRight: '10px', lineHeight: 1}}>
                    <div style={{height: `${gameState.characterOffset}px`}}>
                        <div style={{textAlign:"center", fontWeight: "bolder", textTransform: "uppercase", fontSize: "2.3vw", marginTop:"15px" }}>
                            {gameState.playerOne.affiliation}
                        </div>
                        <div style={{textAlign:"center", fontWeight: "bold", fontSize: "1.8vw", marginTop: "10px"}}>
                            {gameState.playerOne.name}
                        </div>
                        <div style={{textAlign:"center", fontStyle: "italic", fontSize: "1.8vw", marginTop: "10px"}}>

...
const ScorePillBoard = () => {
    ...
    return (
        <div style={{lineHeight: 1, display: "flex", flexDirection:"row", justifyContent: "center", placeItems:"center"}}>
           <div style={{background: gameState.playerOne.color === 'BLUE' ? "rgba(0,125,255,.9)" : "rgba(255,0,0,.9)", border: "5px solid black", borderRadius: "60px", width:"150px", height: "36px", textAlign:"center", fontWeight: "bold", textTransform: "uppercase", fontSize:"32px", marginRight: "-25px", zIndex: "-1"}}>
           ...
           <div style={{background: gameState.playerTwo.color === 'BLUE' ? "rgba(0,125,255,.9)" : "rgba(255,0,0,.9)", border: "5px solid black", borderRadius: "60px", width:"150px", height: "36px", textAlign:"center", fontWeight: "bold", textTransform: "uppercase", fontSize:"32px", marginLeft: "-25px", zIndex: "-1"}}>
